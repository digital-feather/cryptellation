...
func NewLivetestsGrpcClient() (client livetests.LivetestsServiceClient, close func() error, err error) {
	...
	return livetests.NewLivetestsServiceClient(conn), conn.Close, nil
}
